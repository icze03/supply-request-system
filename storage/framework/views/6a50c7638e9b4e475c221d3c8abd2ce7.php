...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div id="pendingContent">
        <?php if($pendingReleases->isNotEmpty()): ?>
            <div class="space-y-4">
                <?php $__currentLoopData = $pendingReleases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden border-l-4 border-yellow-500">
                        <div class="p-6">
                            <!-- Header Row -->
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900">SR #<?php echo e($request->sr_number); ?></h3>
                                    <p class="text-sm text-gray-500 mt-1">Submitted <?php echo e($request->created_at->format('M d, Y h:i A')); ?></p>
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-5 pb-5 border-b border-gray-200">
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-gray-900"><?php echo e($request->user->name); ?></p>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-gray-900"><?php echo e($request->department->name); ?></p>
                                    <p class="text-xs text-gray-600"><?php echo e($request->department->code); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Request Type</p>
                                    <span class="inline-flex px-3 py-1 text-xs font-bold rounded-full <?php echo e($request->request_type === 'special' ? 'bg-purple-100 text-purple-800 border border-purple-300' : 'bg-blue-100 text-blue-800 border border-blue-300'); ?>">
                                        <?php echo e($request->request_type === 'special' ? 'Special' : 'Standard'); ?>

                                    </span>
                                </div>
                                <div>
                                    <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Budget Type</p>
                                    <span class="inline-flex px-3 py-1 text-xs font-bold rounded-full <?php echo e($request->budget_type === 'budgeted' ? 'bg-green-100 text-green-800 border border-green-300' : 'bg-orange-100 text-orange-800 border border-orange-300'); ?>">
                            ...
                            <?php if($request->request_type === 'standard'): ?>
                                <div class="mb-5">
                                    <p class="text-sm font-bold text-gray-700 mb-3">Requested Items (<?php echo e($request->items->count()); ?>)</p>
                                        ...
                                        <div class="space-y-2">
                                            <?php $__currentLoopData = $request->items->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="flex justify-between items-center">
                                                    <span class="text-sm text-gray-900">• <?php echo e($item->item_name); ?></span>
                                                    <span class="text-sm font-semibold text-indigo-600"><?php echo e($item->quantity); ?> <?php echo e($item->supply->unit ?? 'pcs'); ?></span>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($request->items->count() > 5): ?>
                                                <p class="text-xs text-gray-500 italic mt-2">+ <?php echo e($request->items->count() - 5); ?> more item(s)</p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="mb-5">
                                    ...
                                    <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                                        <p class="text-sm text-gray-800"><?php echo e($request->special_item_description); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="flex items-center text-sm text-gray-600 bg-green-50 border border-green-200 rounded-lg p-3 mb-5">
                                ...
                                <span class="font-semibold">Approved by <?php echo e($request->managerApprover->name ?? 'Manager'); ?></span>
                                <span class="mx-2">•</span>
                                <span><?php echo e($request->manager_approved_at->format('M d, Y h:i A')); ?></span>
                            </div>

                            <!-- Action Buttons -->
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                <a href="<?php echo e(route('admin.releases.show', $request->id)); ?>" 
                                ...
                                <button onclick="releaseRequest(<?php echo e($request->id); ?>)" 
                                ...
                                <button onclick="rejectRequest(<?php echo e($request->id); ?>)" 
            ...
            <!-- Pagination -->
            <div class="mt-6">
                <?php echo e($pendingReleases->links()); ?>
    ...
    <div id="todayContent" class="hidden">
        <?php if($releasedToday->count() > 0): ?>
            <div class="bg-white shadow rounded-lg overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $releasedToday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm text-gray-900"><?php echo e($request->department->name); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($request->department->code); ?></div>
                                </td>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center">
                                    <?php echo e($request->admin_released_at->format('h:i A')); ?>

                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-center">
                                    <a href="<?php echo e(route('admin.voucher', $request->id)); ?>" 
                                       target="_blank"
            ...
            <!-- Pagination -->
            <div class="mt-6">
                <?php echo e($releasedToday->links()); ?>
    ...
    <div id="historyContent" class="hidden">
        <?php if($releaseHistory->count() > 0): ?>
            ...
            <div class="bg-white shadow rounded-lg overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="historyTableBody">
                        <?php $__currentLoopData = $releaseHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50" 
                                data-sr="<?php echo e($request->serial_number); ?>" 
                                data-dept="<?php echo e($request->department_id); ?>" 
                                data-date="<?php echo e($request->admin_released_at->format('Y-m-d')); ?>">
                                ...
                                <td class="px-3 py-3 whitespace-nowrap text-center">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($request->budget_type === 'budgeted' ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'); ?>">
                                        <?php echo e($request->budget_type === 'budgeted' ? 'Budgeted' : 'Not Budgeted'); ?>

                                    </span>
                                </td>
                                <td class="px-3 py-3 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($request->admin_released_at->format('M d, Y')); ?>

                                    <div class="text-xs text-gray-400"><?php echo e($request->admin_released_at->format('h:i A')); ?></div>
                                </td>
                                <td class="px-3 py-3 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($request->adminReleaser->name ?? 'N/A'); ?>
                                ...
                                <td class="px-3 py-3 whitespace-nowrap text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <!-- Delete Button -->
                                        <button onclick="deleteHistory(<?php echo e($request->id); ?>, '<?php echo e($request->serial_number); ?>')" 
            ...
            <!-- Pagination -->
            <div class="mt-6">
                <?php echo e($releaseHistory->links()); ?>
