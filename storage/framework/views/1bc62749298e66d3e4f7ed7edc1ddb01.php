        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200" id="usersTableBody">
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="user-row-<?php echo e($user->id); ?>" class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($user->getRoleBadgeColor()); ?>">
                        ...
                        <div class="text-xs text-gray-500"><?php echo e($user->department?->code ?? ''); ?></div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            <button onclick="openEditModal(<?php echo e($user->id); ?>)" class="text-indigo-600 hover:text-indigo-900">Edit</button>
                            <button onclick="openPasswordModal(<?php echo e($user->id); ?>)" class="text-blue-600 hover:text-blue-900">Password</button>
                            <button onclick="deleteUser(<?php echo e($user->id); ?>)" class="text-red-600 hover:text-red-900">Delete</button>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\supply-request-system\resources\views/admin/users/index.blade.php ENDPATH**/ ?>