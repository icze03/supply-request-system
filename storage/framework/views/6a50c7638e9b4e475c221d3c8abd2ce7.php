...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="border-b border-gray-200 mb-6">
        <nav class="-mb-px flex space-x-8">
            <button onclick="switchTab('pending')" id="pendingTab"
                ...
                Pending Release (<?php echo e($pendingReleases->total()); ?>)
            </button>
            <button onclick="switchTab('today')" id="todayTab"
                ...
                Released Today (<?php echo e($releasedToday->total()); ?>)
            </button>
            <button onclick="switchTab('history')" id="historyTab"
                class="border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                Release History (<?php echo e($releaseHistory->total()); ?>)
            </button>
        </nav>
    </div>
    ...
    <div id="pendingContent">
        <?php if($pendingReleases->isNotEmpty()): ?>
            <div class="space-y-4">
                <?php $__currentLoopData = $pendingReleases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $isPartial   = $req->items->contains(fn($i) => ($i->released_quantity ?? 0) > 0);
                        $borderColor = $isPartial ? 'border-blue-500' : 'border-yellow-400';
                    ?>
                    <div class="bg-white shadow rounded-lg overflow-hidden border-l-4 <?php echo e($borderColor); ?>">
                        <div class="p-6">

                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900">SR #<?php echo e($req->sr_number); ?></h3>
                                    <p class="text-sm text-gray-500 mt-0.5">Submitted <?php echo e($req->created_at->format('M d, Y h:i A')); ?></p>
                                </div>
                                <div class="flex flex-col items-end gap-1">
                                    <?php if($isPartial): ?>
                                        ...
                                        <?php if($req->serial_number): ?>
                                            <span class="text-xs font-mono text-blue-600"><?php echo e($req->serial_number); ?></span>
                                        <?php endif; ?>
                                    <?php else: ?>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5 pb-5 border-b border-gray-100">
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-gray-900"><?php echo e($req->user->name); ?></p>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-gray-900"><?php echo e($req->department->name); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($req->department->code); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1">Request Type</p>
                                    <span class="inline-flex px-2 py-0.5 text-xs font-semibold rounded-full
                                        <?php echo e($req->request_type === 'special' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'); ?>">
                                        <?php echo e($req->request_type === 'special' ? 'Special' : 'Standard'); ?>
                                ...
                                <div>
                                    ...
                                    <span class="inline-flex px-2 py-0.5 text-xs font-semibold rounded-full
                                        <?php echo e($req->budget_type === 'budgeted' ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'); ?>">
                                        <?php echo e($req->budget_type === 'budgeted' ? 'Budgeted' : 'Not Budgeted'); ?>

                                    </span>
                                </div>
                            </div>

                            <?php if($req->request_type === 'standard'): ?>
                                <div class="mb-5">
                                    <p class="text-sm font-semibold text-gray-700 mb-2">
                                        Items (<?php echo e($req->items->count()); ?>)
                                        <?php if($isPartial): ?>
                                    ...
                                    <div class="bg-gray-50 rounded-lg divide-y divide-gray-100">
                                        <?php $__currentLoopData = $req->items->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <div class="flex items-center justify-between px-4 py-2.5 gap-3">
                                                ...
                                                <span class="flex-1 min-w-0 text-sm text-gray-800 truncate"><?php echo e($item->item_name); ?></span>
                                                
                                                <div class="shrink-0 flex items-center justify-end gap-2" style="min-width:200px;">
                                                    <?php if($released > 0 && $remaining > 0): ?>
                                                        <span class="text-xs text-blue-600 font-medium whitespace-nowrap"><?php echo e($released); ?>/<?php echo e($original); ?> released</span>
                                                        <span class="px-2.5 py-0.5 text-xs font-semibold rounded-full bg-orange-100 text-orange-700 whitespace-nowrap"><?php echo e($remaining); ?> pending</span>
                                                    <?php elseif($released > 0 && $remaining == 0): ?>
                                                        <span class="px-2.5 py-0.5 text-xs font-semibold rounded-full bg-green-100 text-green-700 whitespace-nowrap">✓ Done</span>
                                                    <?php else: ?>
                                                        <span class="text-sm font-semibold text-gray-700 whitespace-nowrap"><?php echo e($remaining); ?> <span class="font-normal text-gray-400"><?php echo e($item->supply->unit ?? 'pcs'); ?></span></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($req->items->count() > 4): ?>
                                            <div class="px-4 py-2">
                                                <p class="text-xs text-gray-400 italic">+<?php echo e($req->items->count() - 4); ?> more — see full details</p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="mb-5">
                                    ...
                                    <div class="bg-purple-50 border border-purple-200 rounded-lg p-3">
                                        <p class="text-sm text-gray-800"><?php echo e($req->special_item_description); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="flex items-center gap-2 text-sm bg-green-50 border border-green-200 rounded-lg px-4 py-2 mb-5">
                                ...
                                <span class="font-semibold text-green-800"><?php echo e($req->managerApprover->name ?? 'Manager'); ?></span>
                                <span class="text-gray-400">·</span>
                                <span class="text-xs text-gray-500"><?php echo e($req->manager_approved_at->format('M d, Y h:i A')); ?></span>
                            </div>

                            <div class="flex flex-wrap gap-3">
                                <a href="<?php echo e(route('admin.releases.show', $req->id)); ?>"
                                ...
                                <button onclick="releaseRequest(<?php echo e($req->id); ?>)"
                                    ...
                                    <?php echo e($isPartial ? 'Release Remaining' : 'Release Now'); ?>

                                </button>
                                <?php if($req->serial_number): ?>
                                    <a href="<?php echo e(route('admin.voucher', $req->id)); ?>" target="_blank"
                                ...
                                <?php endif; ?>
                                <button onclick="rejectRequest(<?php echo e($req->id); ?>)"
            ...
            <div class="mt-6"><?php echo e($pendingReleases->links()); ?></div>
        <?php else: ?>
    ...
    <div id="todayContent" class="hidden">
        <?php if($releasedToday->count() > 0): ?>
            <div class="bg-white shadow rounded-lg overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $releasedToday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    <p class="text-sm font-mono font-semibold text-indigo-600"><?php echo e($tx->serial_number); ?></p>
                                    <p class="text-xs text-gray-400">Round <?php echo e($tx->round); ?></p>
                                    <?php if($tx->ro_number): ?>
                                        <p class="text-xs text-gray-400">RO: <?php echo e($tx->ro_number); ?></p>
                                    <?php endif; ?>
                                </td>
                                <td class="px-4 py-3">
                                    <a href="<?php echo e(route('admin.releases.show', $tx->supply_request_id)); ?>"
                                       class="text-sm font-semibold text-indigo-600 hover:text-indigo-800">
                                        SR #<?php echo e($tx->supplyRequest->sr_number); ?>

                                    </a>
                                </td>
                                <td class="px-4 py-3">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($tx->supplyRequest->user->name); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($tx->supplyRequest->user->email); ?></div>
                                </td>
                                <td class="px-4 py-3">
                                    <div class="text-sm text-gray-900"><?php echo e($tx->supplyRequest->department->name); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($tx->supplyRequest->department->code); ?></div>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <span class="text-sm font-bold text-gray-800"><?php echo e($tx->items_fully_released_this_round); ?></span>
                                    <span class="text-xs text-gray-400"> / <?php echo e($tx->total_items_in_request); ?></span>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <span class="text-sm font-bold text-green-700">
                                        <?php echo e(collect($tx->items_snapshot)->sum('qty_released')); ?>
                                ...
                                <td class="px-4 py-3 text-center text-sm text-gray-700">
                                    <?php echo e($tx->created_at->format('h:i A')); ?>

                                </td>
                                <td class="px-4 py-3 text-center text-sm text-gray-700">
                                    <?php echo e($tx->releasedBy->name ?? '—'); ?>

                                </td>
                                <td class="px-4 py-3 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="<?php echo e(route('admin.voucher', $tx->supply_request_id)); ?>" target="_blank"
                                        ...
                                        <button onclick="deleteTransaction(<?php echo e($tx->id); ?>, '<?php echo e($tx->serial_number); ?>', <?php echo e($tx->round); ?>)"
            ...
            <div class="mt-6"><?php echo e($releasedToday->links()); ?></div>
        <?php else: ?>
            <div class="bg-white shadow rounded-lg p-16 text-center">
    ...
    <div id="historyContent" class="hidden">
        <?php if($releaseHistory->count() > 0): ?>
            ...
            <div class="bg-white shadow rounded-lg overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="historyTableBody">
                        <?php $__currentLoopData = $releaseHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50"
                                data-sr="<?php echo e(strtolower($tx->serial_number ?? '')); ?>"
                                data-dept="<?php echo e($tx->supplyRequest->department_id); ?>"
                                data-date="<?php echo e($tx->created_at->format('Y-m-d')); ?>"
                                data-type="<?php echo e($tx->is_final_release ? 'final' : 'partial'); ?>">
                                <td class="px-3 py-3">
                                    <p class="text-sm font-mono font-semibold text-indigo-600"><?php echo e($tx->serial_number); ?></p>
                                    <p class="text-xs text-gray-400">Round <?php echo e($tx->round); ?></p>
                                    <?php if($tx->ro_number): ?>
                                ...
                                <td class="px-3 py-3 text-center">
                                    <span class="text-sm font-bold text-green-700"><?php echo e(collect($tx->items_snapshot)->sum('qty_released')); ?></span>
                                    <span class="text-xs text-gray-400"> units</span>
                                </td>
                                <td class="px-3 py-3 text-center">
                                    <?php if($tx->is_final_release): ?>
                                ...
                                <td class="px-3 py-3 text-sm text-gray-700">
                                    <?php echo e($tx->created_at->format('M d, Y')); ?>

                                    <div class="text-xs text-gray-400"><?php echo e($tx->created_at->format('h:i A')); ?></div>
                                </td>
                                <td class="px-3 py-3 text-sm text-gray-700">
                                    <?php echo e($tx->releasedBy->name ?? '—'); ?>
            ...
            <div class="mt-6"><?php echo e($releaseHistory->links()); ?></div>
        <?php else: ?>
            <div class="bg-white shadow rounded-lg p-16 text-center">
                <svg class="mx-auto h-12 w-12 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\supply-request-system\resources\views/admin/releases/index.blade.php ENDPATH**/ ?>