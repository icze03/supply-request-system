...
unset($__errorArgs, $__bag); ?>
    ...
    >
        ...
        <option value="Computer Supplies" <?php echo e(old('category') == 'Computer Supplies' ? 'selected' : ''); ?>>
            Computer Supplies
        </option>
        <option value="Janitorial Supplies" <?php echo e(old('category') == 'Janitorial Supplies' ? 'selected' : ''); ?>>
            Janitorial Supplies
        </option>
        <option value="Office & Store Supplies" <?php echo e(old('category') == 'Office & Store Supplies' ? 'selected' : ''); ?>>
            Office & Store Supplies
        </option>
        <option value="Other Materials & supplies" <?php echo e(old('category') == 'Other Materials & supplies' ? 'selected' : ''); ?>>
