    ...
    <div class="space-y-4">
        <?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden border-l-4
                <?php if($hasPartialRelease): ?> border-blue-400
                <?php elseif($request->status === 'admin_released'): ?> border-green-400
                <?php elseif($request->status === 'manager_approved'): ?> border-yellow-400
                <?php elseif(in_array($request->status, ['admin_rejected', 'manager_rejected'])): ?> border-red-400
            ...
            ">
                <div class="p-5">
                    ...
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            <div class="flex items-center gap-2">
                                <h3 class="text-base font-bold text-gray-900">SR #<?php echo e($request->sr_number); ?></h3>
                                <span class="text-xs text-gray-400">•</span>
                                <span class="text-xs text-gray-500"><?php echo e($request->created_at->format('M d, Y')); ?></span>
                                <span class="text-xs capitalize px-2 py-0.5 rounded-full
                                    <?php echo e($request->request_type === 'special' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'); ?>">
                                    <?php echo e($request->request_type); ?>

                                </span>
                            </div>
                            <p class="text-sm text-gray-500 mt-1 max-w-lg truncate"><?php echo e($request->purpose); ?></p>
                        </div>
                        ...
                        <div class="flex flex-col items-end gap-1 ml-4 shrink-0">
                            <?php if($hasPartialRelease): ?>
                                ...
                                <?php if($request->serial_number): ?>
                                    <span class="text-xs font-mono text-blue-500"><?php echo e($request->serial_number); ?></span>
                                <?php endif; ?>
                            <?php else: ?>
                                ...
                                <?php if($request->serial_number): ?>
                                    <span class="text-xs font-mono text-gray-400"><?php echo e($request->serial_number); ?></span>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <!-- Items Summary -->
                    <?php if($request->request_type === 'standard' && $request->items->count()): ?>
                        <div class="mb-3">
                            <?php if($hasPartialRelease || $hasAnyRelease): ?>
                                    ...
                                    <?php $__currentLoopData = $request->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex items-center justify-between text-sm">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <?php endif; ?>
                                                <span class="text-gray-800"><?php echo e($item->item_name); ?></span>
                                            </div>
                                            <div class="text-right">
                                                <?php if($isDone): ?>
                                                    <span class="text-xs text-green-600 font-semibold">All <?php echo e($original); ?> released</span>
                                                <?php elseif($isPartial): ?>
                                                    <span class="text-xs text-blue-600 font-semibold"><?php echo e($released); ?> released</span>
                                                    <span class="text-xs text-orange-600 font-semibold ml-2"><?php echo e($remaining); ?> pending</span>
                                                <?php else: ?>
                                                    <span class="text-xs text-gray-500"><?php echo e($remaining); ?> <?php echo e($item->supply->unit ?? 'pcs'); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                            ...
                            <?php else: ?>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $request->items->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="inline-flex items-center px-2 py-1 rounded text-xs bg-gray-100 text-gray-700">
                                            <?php echo e($item->item_name); ?>

                                            <span class="ml-1 font-semibold text-indigo-600">×<?php echo e($item->quantity); ?></span>
                                        </span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($request->items->count() > 4): ?>
                                        <span class="inline-flex items-center px-2 py-1 rounded text-xs bg-gray-100 text-gray-500">
                                            +<?php echo e($request->items->count() - 4); ?> more
                                        </span>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php elseif($request->request_type === 'special'): ?>
                        <div class="mb-3">
                            <p class="text-xs text-gray-500 bg-purple-50 border border-purple-100 rounded px-3 py-2 truncate">
                                <?php echo e($request->special_item_description); ?>
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                        ...
                        <div class="text-xs text-gray-400 space-x-3">
                            <?php if($request->manager_approved_at): ?>
                                <span>✓ Approved <?php echo e($request->manager_approved_at->format('M d')); ?></span>
                            <?php endif; ?>
                            <?php if($request->admin_released_at): ?>
                                <span>✓ Released <?php echo e($request->admin_released_at->format('M d')); ?></span>
                            <?php endif; ?>
                            <?php if($request->ro_number): ?>
                                <span class="font-mono">RO: <?php echo e($request->ro_number); ?></span>
                            <?php endif; ?>
                        </div>

                        <!-- Right: actions -->
                        <div class="flex items-center gap-2">
                            <a href="<?php echo e(route('employee.requests.show', $request->id)); ?>"
                            ...
                            <?php if($request->status === 'admin_released' && $request->serial_number && !$hasPartialRelease): ?>
                                <span class="text-gray-300">|</span>
                                <a href="<?php echo e(route('employee.requests.voucher', $request->id)); ?>"
                                target="_blank"
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="bg-white shadow rounded-lg p-12 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    <a href="<?php echo e(route('employee.catalog')); ?>" class="text-indigo-600 hover:text-indigo-900">Create your first request</a>
                </p>
            </div>
        <?php endif; ?>
    </div>
