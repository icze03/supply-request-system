        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $departments->sum(fn($d) => $d->users->count()) }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200" id="departmentsTableBody">
                @foreach($departments as $department)
                    <tr id="dept-row-{{ $department->id }}" class="hover:bg-gray-50">
                        <td class="px-4 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 bg-indigo-100 rounded-full flex items-center justify-center">
                                    <span class="text-indigo-600 font-bold text-sm">{{ substr($department->code, 0, 2) }}</span>
                                </div>
                                <div class="ml-4">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModal({{ $department->id }})" class="text-indigo-600 hover:text-indigo-900 text-xs font-medium">Edit</button>
                                <button onclick="deleteDepartment({{ $department->id }})" class="text-red-600 hover:text-red-900 text-xs font-medium">Delete</button>
                            </div>
                        </td>
                    </tr>
                @endforeach
