...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <option value="Computer Supplies"          <?php echo e(old('category', $supply->category) == 'Computer Supplies'          ? 'selected' : ''); ?>>Computer Supplies</option>
                        <option value="Janitorial Supplies"        <?php echo e(old('category', $supply->category) == 'Janitorial Supplies'        ? 'selected' : ''); ?>>Janitorial Supplies</option>
                        <option value="Office & Store Supplies"    <?php echo e(old('category', $supply->category) == 'Office & Store Supplies'    ? 'selected' : ''); ?>>Office & Store Supplies</option>
                        <option value="Other Materials & supplies" <?php echo e(old('category', $supply->category) == 'Other Materials & supplies' ? 'selected' : ''); ?>>Other Materials & supplies</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <option value="PCS"    <?php echo e(old('unit', $supply->unit) == 'PCS'    ? 'selected' : ''); ?>>Pieces (PCS)</option>
                        <option value="BOX"    <?php echo e(old('unit', $supply->unit) == 'BOX'    ? 'selected' : ''); ?>>Box (BOX)</option>
                        <option value="PACK"   <?php echo e(old('unit', $supply->unit) == 'PACK'   ? 'selected' : ''); ?>>Pack (PACK)</option>
                        <option value="REAM"   <?php echo e(old('unit', $supply->unit) == 'REAM'   ? 'selected' : ''); ?>>Ream (REAM)</option>
                        <option value="SET"    <?php echo e(old('unit', $supply->unit) == 'SET'    ? 'selected' : ''); ?>>Set (SET)</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $supply->description)); ?></textarea>
