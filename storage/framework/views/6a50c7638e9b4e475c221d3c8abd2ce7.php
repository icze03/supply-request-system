                                    ...
                                    <div class="bg-gray-50 rounded-lg divide-y divide-gray-100">
                                        <?php $__currentLoopData = $req->items->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="flex items-center justify-between px-4 py-2">
                                                <span class="text-sm text-gray-800"><?php echo e($item->item_name); ?></span>
                                                <div class="flex items-center gap-3">
                                                    <?php if($released > 0 && $remaining > 0): ?>
                                                        <span class="text-xs text-blue-600 font-medium"><?php echo e($released); ?>/<?php echo e($original); ?> released</span>
                                                        <span class="px-2 py-0.5 text-xs font-semibold rounded-full bg-orange-100 text-orange-700"><?php echo e($remaining); ?> pending</span>
                                                    ...
                                                    <?php else: ?>
                                                        <span class="text-sm font-semibold text-gray-700"><?php echo e($remaining); ?> <span class="font-normal text-gray-400"><?php echo e($item->supply->unit ?? 'pcs'); ?></span></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
