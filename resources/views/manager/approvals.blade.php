                    ...
                    <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                        ...
                        <div class="px-6 py-4 space-y-4">
                            ...
                            @if($request->request_type === 'standard')
                                <div>
                                    <p class="text-sm font-medium text-gray-700 mb-2">Items ({{ $request->items->count() }}):</p>
                                            ...
                                            <tbody class="divide-y divide-gray-200">
                                                @foreach($request->items as $item)
                                                    <tr>
                                                        ...
                                                        <td class="py-2 text-sm text-gray-500 font-mono">{{ $item->item_code }}</td>
                                                        <td class="py-2 text-sm text-gray-900 text-right font-semibold">{{ $item->quantity }}</td>
                                                        <td class="py-2 text-sm text-gray-500">{{ $item->supply->unit ?? 'N/A' }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
