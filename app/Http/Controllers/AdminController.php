...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Low stock for dashboard only (not in supplies page)
    ...
    /**
     * Display supplies list - WITH STOCK QUANTITY VISIBLE
     */
    ...
    /**
     * Store new supply - FIXED
     */
    public function suppliesStore(Request $request)
{
    \Log::info('=== SUPPLY CREATE ATTEMPT ===');
    ...
    try {
        ...
        // item_code will be auto-generated in model's boot method
        ...
        \Log::error('Supply Creation Failed:', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
        ...
        return back()
            ->withInput()
            ->with('error', 'Failed to create supply: ' . $e->getMessage());
    }
}
    ...
    /**
     * Update supply - FIXED STOCK UPDATE
     */
    public function suppliesUpdate(Request $request, $id)
    {
        $supply = Supply::findOrFail($id);
        
        \Log::info('=== UPDATE SUPPLY ===', [
            'id' => $id,
            'old_stock' => $supply->stock_quantity,
        ...
        try {
            ...
            $supply->refresh();
            \Log::info('Supply updated', ['new_stock' => $supply->stock_quantity]);
    ...
    /**
     * Toggle supply active status (AJAX)
     */
    ...
    /**
     * Display low stock alerts page (separate from supplies)
     */
    ...
    public function releaseRequest(Request $request, $id)
    {
        ...
        DB::beginTransaction();
        try {
            // Generate serial number: DEPT-YYYYMMDD-0001
            ...
            // Deduct stock BEFORE updating status
