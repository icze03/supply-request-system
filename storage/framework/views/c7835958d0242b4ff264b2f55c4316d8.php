...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900"><?php echo e($totalSupplies); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900"><?php echo e($activeSupplies); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900"><?php echo e($pendingApproval); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900"><?php echo e($releasedToday); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="text-sm font-medium text-yellow-900"><?php echo e($pendingApproval); ?> request(s) awaiting release</h3>
                    <p class="text-sm text-yellow-700">These requests have been approved by managers and need final release</p>
                </div>
            </div>
            <a href="<?php echo e(route('admin.releases.index')); ?>" class="px-4 py-2 bg-yellow-600 text-white text-sm font-medium rounded-md hover:bg-yellow-700">
                Process Releases
            </a>
        </div>
    </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button
                            type="button"
                            onclick="openDeptModal(<?php echo e($dept->id); ?>, '<?php echo e(addslashes($dept->name)); ?>', '<?php echo e($dept->code); ?>')"
                        ...
                        >
                            <div class="flex items-center justify-between mb-2">
                                <h3 class="font-semibold text-gray-900 group-hover:text-indigo-700 transition-colors"><?php echo e($dept->name); ?></h3>
                                <div class="flex items-center gap-2">
                                    <span class="px-2 py-1 text-xs font-semibold rounded bg-gray-100 text-gray-800 group-hover:bg-indigo-100 group-hover:text-indigo-800 transition-colors"><?php echo e($dept->code); ?></span>
                            ...
                            <p class="text-2xl font-bold text-indigo-600"><?php echo e($dept->supply_requests_count); ?></p>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="<?php echo e(route('admin.releases.index')); ?>" class="text-sm text-indigo-600 hover:text-indigo-900">View All</a>
        </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs font-semibold rounded bg-blue-100 text-blue-800">
                                    <?php echo e($request->department->code); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($request->managerApprover->name ?? 'N/A'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\supply-request-system\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>