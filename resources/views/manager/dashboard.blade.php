...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">{{ auth()->user()->department->name }} Department</p>
    </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900">{{ $approvedToday }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900">{{ $rejectedToday }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-4 mb-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="text-sm font-medium text-blue-900">You have {{ $pendingCount }} pending request(s)</h3>
                    <p class="text-sm text-blue-700">Review and approve employee requests</p>
                </div>
            </div>
<a href="{{ route('manager.approvals.index') }}" class="px-4 py-2 bg-blue-400 text-white text-sm font-medium rounded-md hover:bg-blue-500">                
    Review Now
            </a>
        </div>
    </div>
...
<a href="{{ route('manager.approvals.index') }}" class="text-sm text-indigo-600 hover:text-indigo-900">View All</a>        </div>
                    ...
                    @forelse($pendingRequests as $request)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <button onclick="showApprovalModal({{ $request->id }}, 'approve')" class="text-green-600 hover:text-green-900">Approve</button>
                                <button onclick="showApprovalModal({{ $request->id }}, 'reject')" class="text-red-600 hover:text-red-900">Reject</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
