...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Welcome back, <?php echo e(auth()->user()->name); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <p class="text-3xl font-bold text-gray-900"><?php echo e($totalDepartments); ?></p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="divide-y divide-gray-50">
            ...
            <div class="px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-xs text-gray-500"><?php echo e($user->department?->name ?? '—'); ?></span>
                    <span class="px-2 py-1 rounded-full text-xs font-semibold <?php echo e($user->getRoleBadgeColor()); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\supply-request-system\resources\views/hr_manager/dashboard.blade.php ENDPATH**/ ?>